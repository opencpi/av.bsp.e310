...
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_0}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_0}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_0}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_0}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_1}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_1}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_1}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_1}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_2}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_2}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_2}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_2}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_3}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_3}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_3}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_3}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_4}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_4}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_4}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_4}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_5}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_5}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_5}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_5}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_6}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_6}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_6}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_6}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_7}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_7}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_7}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_7}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_8}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_8}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_8}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_8}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_9}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_9}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_9}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_9}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_10}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_10}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_10}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_10}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_11}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}] -clock_fall -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_11}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -min -add_delay $min_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_11}]
set_input_delay -clock [get_clocks {E3XX_CONN_CAT_DATA_CLK}]             -max -add_delay $max_rx_delay [get_ports {E3XX_CONN_CAT_P0_D_11}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_0}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_0}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_0}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_0}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_1}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_1}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_1}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_1}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_2}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_2}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_2}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_2}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_3}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_3}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_3}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_3}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_4}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_4}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_4}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_4}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_5}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_5}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_5}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_5}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_6}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_6}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_6}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_6}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_7}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_7}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_7}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_7}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_8}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_8}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_8}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_8}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_9}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_9}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_9}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_9}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_10}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_10}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_10}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_10}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_11}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}] -clock_fall -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_11}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -min -add_delay $min_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_11}]
set_output_delay -clock [get_clocks {E3XX_CONN_CAT_FB_CLK}]             -max -add_delay $max_tx_delay [get_ports {E3XX_CONN_CAT_P1_D_11}]
