...
run_delay_tests_1r1t() {
  ...
  do
    ...
    OCPI_LIBRARY_PATH=$OCPI_LIBRARY_PATH:$OCPI_CDK_DIR/../projects/core/exports:./assemblies/:$OCPI_PROJECT_PATH:../lib P="-pfile_write=filename=$FILENAME $@" TX_DATA_CLOCK_DELAY=$clkdelay TX_DATA_DELAY=$datadelay ./scripts/run_app.sh $APP_XML $APP_RUNTIME_SEC $twortwot > $LOGFILENAME 2>&1
