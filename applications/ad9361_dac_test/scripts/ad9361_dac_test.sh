...
if [ -n "$SINGLE_PORT" ]; then
  ...
  MODE="CMOS FDD"
  APP_XML=ad9361_test_1r1t_cmos_single_port_fdd_app.xml
#else
#  MODE="CMOS mode 5"
...
if [ "$DO_PRBS" == "1" ]; then
  ...
  diff odata/AD9361_BIST_PRBS.log scripts/AD9361_BIST_PRBS.delays_7_0_12_0.use_ext_refclk.cmos_single_port_fdd.golden
  XX=$?
...
diff odata/AD9361_BIST_loopback.log scripts/AD9361_BIST_loopback.delays_7_0_12_0.use_ext_refclk.cmos_single_port_fdd.golden
