...
INCS = -I$(OCPI_INC_DIR) -I$(OCPI_PREREQUISITES_DIR)/ad9361/include/  -I$(call OcpiGetRccPlatformDir,$(OCPI_TARGET_PLATFORM))/include/
#../../../imports/ocpi.core/rcc/platforms/$(OCPI_TARGET_PLATFORM)
